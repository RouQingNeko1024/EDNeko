...
object Velocity : Module("Velocity", Category.COMBAT) {
    ...
    private val horizontal by float("Horizontal", 0F, -10F..10F) { mode in arrayOf("Simple", "AAC", "Legit") }
    private val vertical by float("Vertical", 0F, -10F..10F) { mode in arrayOf("Simple", "Legit") }
