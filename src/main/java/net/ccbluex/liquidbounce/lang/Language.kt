...
object LanguageManager : MinecraftInstance {
     ...
     *
     * Languages are stored in assets/minecraft/edneko/lang and when loaded will be stored in [languageMap]
     */
    fun loadLanguages() {
        for (language in knownLanguages) {
            runCatching {
                languageMap[language] = javaClass.getResourceAsStream("/assets/minecraft/edneko/lang/$language.json")!!
