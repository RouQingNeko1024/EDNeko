...
If your code is self-contained and not designed exclusively for edneko, we may allow you to include it in a separate package outside `net.ccbluex.liquidbounce`. Please note that we have to decide on a case by case basis.
