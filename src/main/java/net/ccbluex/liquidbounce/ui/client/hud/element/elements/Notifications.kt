...
class Notifications(
    ...
    enum class SeverityType(val path: ResourceLocation) {
        SUCCESS(ResourceLocation("edneko/notifications/success.png")), RED_SUCCESS(ResourceLocation("edneko/notifications/redsuccess.png")), INFO(
            ResourceLocation("edneko/notifications/info.png")
        ),
        WARNING(ResourceLocation("edneko/notifications/warning.png")), ERROR(ResourceLocation("edneko/notifications/error.png"))
    }
}
